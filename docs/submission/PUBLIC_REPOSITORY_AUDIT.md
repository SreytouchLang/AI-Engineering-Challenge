...
- Repository URL: https://github.com/SreytouchLang/AI-Engineering-Challenge
- Visibility check: anonymous `curl -I` against the repository URL returned `HTTP/2 200`.
- Default branch: `main`
